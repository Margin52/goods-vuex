    ...
    <div class="in-con">
      <div class="in-con-box">
        <div class="in-con-box-input-peo">
          ...
          <input type="text" class="in-con-box-input-peo-input" placeholder="收货人姓名" value="齐德龙">
        ...
        <div class="in-con-box-input-tel">
          ...
          <input type="text" class="in-con-box-input-tel-input" placeholder="收货人手机号码" value="15202926079">
        </div>
        ...
        <div class="in-con-box-input-area">
          ...
          <input type="text" class="in-con-box-input-tel-input" placeholder="街道、楼牌号等" value="华远北街通港大厦7层703室">
        </div>
        <div class="in-con-box-input-def">
          <span class="in-con-box-input-peo-span">详细地址</span>
          <img class="in-con-box-input-def-img" src="../../static/images/in-con-two.png" alt="">
        </div>
      </div>
      <p class="in-con-save">保存</p>
      <p class="in-con-del">删除</p>
    </div>
  </div>
</template>
